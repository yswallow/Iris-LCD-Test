...
#define IRIS_DATABUS	GPIOA
#define IRIS_CONFIG		GPIOB
...
#define IRIS_SUB_WRX_PIN    GPIO_PIN_7
#define IRIS_SUB_CSX_PIN	GPIO_PIN_5
#define IRIS_SUB_DCX_PIN	GPIO_PIN_6
